...
class VendingMachineDemo:
    ...
    def run():
        ...
        vending_machine.addItem("A1", "Coke", 25, 3)
        vending_machine.addItem("A2", "Pepsi", 25, 2)
        vending_machine.addItem("B1", "Water", 10, 5)
        ...
        # Insert coins
        print("\n--- Step 2: Insert coins ---")
        vending_machine.insert_money(Coin.DIME)  # 10
        vending_machine.insert_money(Coin.DIME)  # 10
        vending_machine.insert_money(Coin.NICKEL)  # 5
        ...
        vending_machine.insert_money(Coin.QUARTER)  # 25
