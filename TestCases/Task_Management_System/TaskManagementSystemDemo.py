...
from SortingStrategy.SortByDueDate import SortByDueDate
...
class TaskManagementSystemDemo:
    ...
    def main():
        ...
        # Create users
        user1 = task_management_system.create_user("u1", "John Doe", "john@example.com")
        user2 = task_management_system.create_user("u2", "Jane Smith", "jane@example.com")
